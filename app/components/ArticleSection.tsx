// Hoisted static Like Icon SVG (rendering-hoist-jsx)
const LikeIcon = (
  <svg
...
export default function ArticleSection() {
  return (
    <section className="flex flex-col gap-1.5 w-full mt-10 [content-visibility:auto] [contain-intrinsic-size:0_400px]">
      <h3 className="font-mono uppercase font-normal px-3">Articles</h3>
      <div className="grid relative z-10 col-start-1 col-end-13 md:grid-cols-2 grid-gap w-full gap-1.5">
        <article className="flex gap-0.5 flex-col md:flex-row w-full">
          <div className="bg-[#F5F5F5] shrink-0 rounded-xl w-full md:w-[220px] h-[300px] relative cursor-pointer" />
          <div className="flex flex-col gap-2 mt-2 px-3 h-full">
            ...
            <ul className="font-mono font-medium text-black/60 text-xs flex flex-wrap gap-1 max-w-[300px]">
